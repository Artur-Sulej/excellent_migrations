defmodule ExcellentMigrations.ConfigCommentsParserTest do
  ...
  test "finds lines with config comment disable-for-file" do
    source_code = File.read!("test/example_migrations/20191026103009_safety_assured_with_config_comments.exs")
  ...
  test "finds lines with config comment disable-for-next-line" do
    source_code = "    # excellent_migrations:safety-assured-for-next-line raw_sql_executed column_renamed"
